...
最后核验：2026-07-16。本清单记录当前 Demo 直接使用的非软件内容，不替代权利人的许可文件。
...
以下文件仍存在于目录中，但当前 `adv.config.ts` 与故事脚本不再引用；在来源确认前不得重新用于正式 Demo：

- `public/icons/pwa-192x192.png`、`public/icons/pwa-512x512.png`
- `public/img/icons/favicon-32x32.png`
- `public/img/characters/she/**`、`public/img/characters/he/**`
- `public/img/bg/night.jpg`

上述历史文件的原始作者、生成步骤或许可尚未核验，状态为 **待确认**。

## 新增素材登记要求

新增内容至少记录仓库路径或 URL、作品名与作者、原始来源、明确许可、核验日期，以及裁剪/翻译/改色等修改。来源或许可未确认的素材不应进入正式演示路径。
